          ...
          <div className="prop2-contact-box">
            ...
            <div className="prop2-contact-right">
              <div className="prop2-contact-cta-card">
                ...
                <p>Escríbenos o visítanos directamente en la Facultad para iniciar tu inscripción.</p>
                <a href="mailto:propedeuticofeca@ujed.mx" className="prop2-cta-primary prop2-cta-full">
                  Escribir para inscribirme
