...
export default function LicenciaturaDetailPage({ slug, logoImage, newsPanelOpen, setNewsPanelOpen }) {
  ...
  const { abbr, name, plan, heroImg, coordinador, tagline, resumen, perfilIngreso, perfilEgreso, campoLaboral, destacados, planEstudiosHref, mapaCurricularImg } = licenciatura;
